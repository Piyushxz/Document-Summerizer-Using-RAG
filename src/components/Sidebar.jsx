...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div 
         className="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-gray-800 ">
          <ul onClick={() => modalDispatch({ type: 'OPEN_SIGNIN_MODAL' })}
          ...
          <ul onClick={() => modalDispatch({ type: 'OPEN_SIGNUP_MODAL' })}
          className="space-y-2 font-medium">
            <li>
              <div 
              className="flex  font-montserrat font-semibold items-center p-2 text-white rounded-lg dark:text-white hover:bg-customGray border-2 border-customGray group mt-2 ">
